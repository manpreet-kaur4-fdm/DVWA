...
with (thisform) {
  ...
  // Guestbook form
  if (validate_required(txtName,"Subject can not be empty.")==false)
  {txtName.focus();return false;}
  
  if (validate_required(mtxMessage,"Comment can not be empty.")==false)
...
function confirmClearGuestbook() {
	return confirm("Are you sure you want to clear the Feedbacks?");
}
